    ...
    <div id="loginbox" style="margin-top:50px;" class="mainbox col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2">
        <div class="panel panel-info" >
            <div class="panel-heading"> 
                <div class="panel-title">AFFE - Recuparar a senha</div>
            </div>
            <div style="padding-top:30px" class="panel-body" >
                ...
                <form action="#" id="formrecupararsenha" class="form-horizontal" role="form">
                    <div style="margin-bottom: 25px" class="input-group">
                        ...
                        <input id="login-username" type="text" class="form-control" name="usuario" placeholder="Usuario" value="<?PHP echo $username;?>" >
                    </div>
                    <div style="margin-bottom: 25px" class="input-group">
