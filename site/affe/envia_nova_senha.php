...
if($rs > 0){
    ...
    foreach ($result as $row) {
        ...
        $link = '<a href="https://affe.makecard.com.br/alterar_senha.php?chave='. $chave .'&user='.$usuario.'">https://affe.makecard.com.br/alterar_senha.php?chave=' . $chave . '&user='.$usuario.'</a>';
        $nome = $row['nome'];
    }
    ...
    try {
        ...
        $mail->Username   = 'tecnologiaaffe@gmail.com'; // SMTP username
        $mail->Password   = 'obvz ermy kpsc ifro';
        ...
        //Recipients
        $mail->setFrom('tecnologiaaffe@gmail.com', 'Admin AFFE');
        $mail->addAddress($email, $nome);     // Add a recipient
        $mail->addReplyTo('no-reply@makecard.com.br', 'No reply');

        // Content
        $mail->isHTML(true);                                  // Set email format to HTML
        $mail->Subject = 'Recuperar a senha do sistema AFFE';
                                        ...
                                        <table align=\"center\" border=\"0\" cellpadding=\"0\" cellspacing=\"0\" width=\"600\" style=\"border: 1px solid #cccccc; border-collapse: collapse;\">
                                            <tr>
                                                <td align=\"center\" bgcolor=\"#f5f5dc\" style=\"padding: 40px 0 20px 0; color: #153643; font-size: 28px; font-weight: bold; font-family: Arial, sans-serif;\">
                                                    <img src=\"https://affe.makecard.com.br/pictures_site-sind/logo.png\" alt=\"Recuperar Senha\" width=\"280\" height=\"90\" style=\"display: block;\" />
                                                </td>
                                            </tr>
                                            <tr>
