                                ...
                                <form name="busca_associado" id="busca_associado" method="post" action="#">
                                    ...
                                    <tr>
                                        ...
                                        <td style="border: 0;padding-bottom: 0px;">
                                            <button id="btnLocaliza" class="btn btn-primary">Localizar</button>
                                        </td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td style="width: 40px;height: 60px;border: 0;padding-bottom: 0px;">
                                            <input type="text"   id="valor_pedido"        name="valor_pedido" autocomplete="off"  style="font-weight: bold;"      class="form-control" maxlength="8" />
                                        ...
                                        <td colspan="2" rowspan="3" style="width: 70px;border: 0;padding-bottom: 0px;">
                                            <div class="alert alert-warning" id="msg_parcela" style="display: none; height: 75px;width: 230px; padding-top: 4px;padding-left: 15px;border: 0;font-weight: bold;padding-bottom: 15px;" role="alert">
                                    ...
                                    <tr>
                                        ...
                                        <td  style="width: 100px;border: 0;padding-top: 0px;">
                                            <input type="password" class="form-control" autocomplete="off" id="pass" name="pass">
                                        </td>
                ...
                <div id="infosucesso">
                    ...
                    <div class="row">
                        <div class="col-md-12 text-center" style="color: #0000CC; padding: 2px">
                            Total : <span id="valorpedido"></span>
                        </div>
                    </div>
                    <div class="row">
